---
name: doc-lookup
description: Look up library, framework, API, or CLI docs. Triggers - "how does X work in <lib>", version/migration questions, config syntax, an API guess about to be made from training data.
---
